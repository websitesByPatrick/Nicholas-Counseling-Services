const Header = () => {
  return (
      ...
      <div className="w-full h-52 bg-slate-800 text-center placeholder:shadow-2xl shadow-gray-900 flex justify-center items-center gap-10">

        <div className="w-40 h-40  border-slate-900 bg-slate-800 flex justify-center shadow-xl shadow-slate-600 rounded-full">
          <img className="w-40 rounded-full m-2  shadow-gray-500" src="../public/marica.jpg" alt="" />
        </div>
